...
class MoveBaseSquare():
	...
	#point to point
		...
		rospy.loginfo("goal[%5.3f, %5.3f],robot[%5.3f, %5.3f]", self.goalpoint.x,self.goalpoint.y,robot_position.x,robot_position.y)  

		#global error_pre,I,D,thetai,thetad,thetad_p
		self.distanceToGoal = sqrt(pow((self.goalpoint.x - robot_position.x), 2) + pow((self.goalpoint.y - robot_position.y), 2))	
		self.angleToGoal = (atan2(self.goalpoint.y - robot_position.y, self.goalpoint.x - robot_position.x) - rotation)
